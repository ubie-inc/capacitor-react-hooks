  ...
  return (
    <IonPage>
      ...
      <IonContent>
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>useStorage</IonCardTitle>
          </IonCardHeader>
          <IonCardContent>
            <p>
              isAvailable on {platform}: {JSON.stringify(availableFeatures.useStorage)}{' '}
            </p>
            {availableFeatures.useStorage && (
              <>
                <p>
                  Key: <IonInput value={keyText} onIonChange={(e) => setKeyText(e.detail.value!)} />
                </p>
                <p>
                  Value:{' '}
                  <IonInput value={valueText} onIonChange={(e) => setValueText(e.detail.value!)} />
                </p>
                <p>
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>useStorageItem</IonCardTitle>
          </IonCardHeader>
          <IonCardContent>
            <p>
              isAvailable on {platform}: {JSON.stringify(availableFeatures.useStorage)}{' '}
            ...
            {availableFeatures.useStorage && (
              <>
                ...
                <p>
                  ...
                  <IonInput
                    value={itemValueText}
                    onIonChange={(e) => setItemValueText(e.detail.value!)}
                  />
                </p>
                <p>
