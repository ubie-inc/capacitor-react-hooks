  ...
  return (
    <IonPage>
      ...
      <IonContent>
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>useCurrentPosition</IonCardTitle>
          </IonCardHeader>
          <IonCardContent>
            <p>
              isAvailable on {platform}: {JSON.stringify(availableFeatures.getCurrentPosition)}
            </p>
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>useWatchPosition</IonCardTitle>
          </IonCardHeader>
          <IonCardContent>
            <p>
              isAvailable on {platform}: {JSON.stringify(availableFeatures.watchPosition)}
            </p>
            {availableFeatures.watchPosition && (
              <>
                ...
                <p>
                  <IonButton onClick={() => startWatch()}>Start watching location</IonButton>
                </p>
                <p>
                  <IonButton onClick={() => clearWatch()}>Stop watching location</IonButton>
                </p>
              </>
            )}
          </IonCardContent>
